...
Note: This demo was set up using the following configuration:
...
1. Download the software from [here](https://portal.influxdata.com/downloads/).
1. Follow the [installation instructions](https://docs.influxdata.com/influxdb/v1.7/introduction/installation/).
...
1. In the command window, type the following:
	...
	```
	Note: This installation is only for the purposes of running the demo, so the credentials aren't set.
...
Note: Make sure you have already cloned the InsightEdge metrics demo software from Github; you will need the files when you configure the Grafana client.
...
Note: For more information about the GigaSpaces Helm charts and how to install and configure InsightEdge and XAP in Kubernetes, see the [KubeGrid](https://docs-staging.gigaspaces.com/xap/14.0/admin/kubernetes-overview.html) section of the product documentation.
